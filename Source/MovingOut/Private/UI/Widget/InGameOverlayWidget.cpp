...
void UInGameOverlayWidget::HandleObjective(int32 Remaining, int32 Total)
{
	if (ObjectiveText)
	{
		const int32 Delivered = FMath::Max(0, Total - Remaining);
...
void UInGameOverlayWidget::UpdateTimeProgressBar(int32 ElapsedTime, int32 Total)
{
